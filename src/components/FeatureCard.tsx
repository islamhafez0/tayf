...
const FeatureCard = ({ id, title, description }: FeatureCardProps) => {
  ...
  return (
    <li
      ...
      className="flex flex-col items-center space-y-[30px] text-center py-10 px-[30px] rounded-[20px] bg-white shadow-features-dropshadow border border-[#E5F4F2] bg-no-repeat bg-center bg-cover"
